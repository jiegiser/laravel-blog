...
@section('content')
    <div class="banner">
        <section class="box">
            <ul class="texts">
                <p>洪水灾害是区域经济社会可持续发展的重要制约因素之一。</p>
                <p>洪水灾害不仅对区域内的基础设施造成毁灭性破坏。</p>
                <p>而且对人民群众的生命安全构成极大的威胁和损害，已经成为当前防汛抗旱中的突出问题。</p>
            </ul>
            <div class="avatar"><a href="#"><span>管理员</span></a> </div>
        </section>
    </div>
    <div class="template">
        <div class="box">
            <h3>
                <p><span>预警</span>信息发布</p>
            </h3>
            <ul>
                @foreach($pics as $p)
